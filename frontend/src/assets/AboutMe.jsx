...
function AboutMe(props){
  ...
  return(
    <div className={'card aboutMe'+props.carddark} style={dynoGrid}>
      ...
      <p>I am a recent graduate from the University of central Florida, with bachelors in Web design and social platforms
      </p>
      <p>I am a recent graduate from the University of central Florida, with bachelors in Web design and social platformI am a recent graduate from the University of central Florida, with bachelors in Web design and social platform
      </p>
    </div>
  ) 
